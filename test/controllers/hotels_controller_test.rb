...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { address: @hotel.address, name: @hotel.name, total_room: @hotel.total_room } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { address: @hotel.address, name: @hotel.name, total_room: @hotel.total_room } }
